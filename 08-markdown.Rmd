...
Markdown is a simple, easy-to-read markup language that can be converted to HTML.
...
If you don't have the altmetrics project open, choose to open the project using the menu we discussed [in the earlier lesson where we created our RStudio project](https://jdblischak.github.io/r-intermediate-altmetrics/03-rstudio.html).
